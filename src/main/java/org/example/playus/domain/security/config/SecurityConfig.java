    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .cors(cors -> cors.configurationSource(request -> {
                    ...
                    config.setAllowedOrigins(List.of("http://localhost:3000", "http://localhost:8080", "http://34.122.87.147", "http://35.184.127.151", "https://dostep.vercel.app/"));
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(HttpMethod.OPTIONS, "/**").permitAll()  // OPTIONS 메서드 허용// POST 요청 허용
                        .requestMatchers("/api/auth/**", "/google/**", "/swagger-ui/**", "/v3/api-docs/**").permitAll()

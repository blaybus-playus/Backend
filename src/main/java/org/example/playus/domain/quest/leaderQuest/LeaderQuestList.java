...
public class LeaderQuestList {
    ...
    @Builder
    public LeaderQuestList(String id, String questName, String period, String totalScore, int maxScore, int mediumScore, String requireForMax, String requireForMedium) {
        this.id = id;
